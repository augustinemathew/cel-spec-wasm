...
constexpr std::array<Seed, 235> kBuiltinSeeds{
    ...
    //
    // Scalar.
    Seed{"math_ceil_double", {ImportModule::kCelRuntime, "cel_math_ceil_at_v"}},
    Seed{"math_floor_double",
         {ImportModule::kCelRuntime, "cel_math_floor_at_v"}},
    Seed{"math_round_double",
         {ImportModule::kCelRuntime, "cel_math_round_at_v"}},
    Seed{"math_trunc_double",
         {ImportModule::kCelRuntime, "cel_math_trunc_at_v"}},
    Seed{"math_isInf_double",
         {ImportModule::kCelRuntime, "cel_math_is_inf_at_v"}},
    Seed{"math_isNaN_double",
         {ImportModule::kCelRuntime, "cel_math_is_nan_at_v"}},
    Seed{"math_isFinite_double",
         {ImportModule::kCelRuntime, "cel_math_is_finite_at_v"}},
    Seed{"math_abs_int", {ImportModule::kCelRuntime, "cel_math_abs_at_v"}},
    Seed{"math_abs_uint", {ImportModule::kCelRuntime, "cel_math_abs_at_v"}},
    Seed{"math_abs_double", {ImportModule::kCelRuntime, "cel_math_abs_at_v"}},
    Seed{"math_sign_int", {ImportModule::kCelRuntime, "cel_math_sign_at_v"}},
    Seed{"math_sign_uint", {ImportModule::kCelRuntime, "cel_math_sign_at_v"}},
    Seed{"math_sign_double", {ImportModule::kCelRuntime, "cel_math_sign_at_v"}},
    Seed{"math_sqrt_int", {ImportModule::kCelRuntime, "cel_math_sqrt_at_v"}},
    Seed{"math_sqrt_uint", {ImportModule::kCelRuntime, "cel_math_sqrt_at_v"}},
    Seed{"math_sqrt_double", {ImportModule::kCelRuntime, "cel_math_sqrt_at_v"}},
    // Bitwise.
    Seed{"math_bitAnd_int_int",
         {ImportModule::kCelRuntime, "cel_math_bit_and_at_vv"}},
    Seed{"math_bitAnd_uint_uint",
         {ImportModule::kCelRuntime, "cel_math_bit_and_at_vv"}},
    Seed{"math_bitOr_int_int",
         {ImportModule::kCelRuntime, "cel_math_bit_or_at_vv"}},
    Seed{"math_bitOr_uint_uint",
         {ImportModule::kCelRuntime, "cel_math_bit_or_at_vv"}},
    Seed{"math_bitXor_int_int",
         {ImportModule::kCelRuntime, "cel_math_bit_xor_at_vv"}},
    Seed{"math_bitXor_uint_uint",
         {ImportModule::kCelRuntime, "cel_math_bit_xor_at_vv"}},
    Seed{"math_bitNot_int_int",
         {ImportModule::kCelRuntime, "cel_math_bit_not_at_v"}},
    Seed{"math_bitNot_uint_uint",
         {ImportModule::kCelRuntime, "cel_math_bit_not_at_v"}},
    Seed{"math_bitShiftLeft_int_int",
         {ImportModule::kCelRuntime, "cel_math_bit_shift_left_at_vv"}},
    Seed{"math_bitShiftLeft_uint_int",
         {ImportModule::kCelRuntime, "cel_math_bit_shift_left_at_vv"}},
    Seed{"math_bitShiftRight_int_int",
         {ImportModule::kCelRuntime, "cel_math_bit_shift_right_at_vv"}},
    Seed{"math_bitShiftRight_uint_int",
         {ImportModule::kCelRuntime, "cel_math_bit_shift_right_at_vv"}},
    // Variadic min — unary (identity → cel_copy_slot), pairwise, list.
    Seed{"math_@min_int", {ImportModule::kCelRuntime, "cel_copy_slot"}},
    Seed{"math_@min_uint", {ImportModule::kCelRuntime, "cel_copy_slot"}},
    Seed{"math_@min_double", {ImportModule::kCelRuntime, "cel_copy_slot"}},
    Seed{"math_@min_int_int",
         {ImportModule::kCelRuntime, "cel_math_min_at_vv"}},
    Seed{"math_@min_int_uint",
         {ImportModule::kCelRuntime, "cel_math_min_at_vv"}},
    Seed{"math_@min_int_double",
         {ImportModule::kCelRuntime, "cel_math_min_at_vv"}},
    Seed{"math_@min_uint_int",
         {ImportModule::kCelRuntime, "cel_math_min_at_vv"}},
    Seed{"math_@min_uint_uint",
         {ImportModule::kCelRuntime, "cel_math_min_at_vv"}},
    Seed{"math_@min_uint_double",
         {ImportModule::kCelRuntime, "cel_math_min_at_vv"}},
    Seed{"math_@min_double_int",
         {ImportModule::kCelRuntime, "cel_math_min_at_vv"}},
    Seed{"math_@min_double_uint",
         {ImportModule::kCelRuntime, "cel_math_min_at_vv"}},
    Seed{"math_@min_double_double",
         {ImportModule::kCelRuntime, "cel_math_min_at_vv"}},
    Seed{"math_@min_list_int",
         {ImportModule::kCelRuntime, "cel_math_min_list_at_v"}},
    Seed{"math_@min_list_uint",
         {ImportModule::kCelRuntime, "cel_math_min_list_at_v"}},
    Seed{"math_@min_list_double",
         {ImportModule::kCelRuntime, "cel_math_min_list_at_v"}},
    // Variadic max.
    Seed{"math_@max_int", {ImportModule::kCelRuntime, "cel_copy_slot"}},
    Seed{"math_@max_uint", {ImportModule::kCelRuntime, "cel_copy_slot"}},
    Seed{"math_@max_double", {ImportModule::kCelRuntime, "cel_copy_slot"}},
    Seed{"math_@max_int_int",
         {ImportModule::kCelRuntime, "cel_math_max_at_vv"}},
    Seed{"math_@max_int_uint",
         {ImportModule::kCelRuntime, "cel_math_max_at_vv"}},
    Seed{"math_@max_int_double",
         {ImportModule::kCelRuntime, "cel_math_max_at_vv"}},
    Seed{"math_@max_uint_int",
         {ImportModule::kCelRuntime, "cel_math_max_at_vv"}},
    Seed{"math_@max_uint_uint",
         {ImportModule::kCelRuntime, "cel_math_max_at_vv"}},
    Seed{"math_@max_uint_double",
         {ImportModule::kCelRuntime, "cel_math_max_at_vv"}},
    Seed{"math_@max_double_int",
         {ImportModule::kCelRuntime, "cel_math_max_at_vv"}},
    Seed{"math_@max_double_uint",
         {ImportModule::kCelRuntime, "cel_math_max_at_vv"}},
    Seed{"math_@max_double_double",
         {ImportModule::kCelRuntime, "cel_math_max_at_vv"}},
    Seed{"math_@max_list_int",
         {ImportModule::kCelRuntime, "cel_math_max_list_at_v"}},
    Seed{"math_@max_list_uint",
         {ImportModule::kCelRuntime, "cel_math_max_list_at_v"}},
