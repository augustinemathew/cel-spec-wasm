...
| `compiler/celfn/celfnc_emit/` (wit/codec/skeleton/stub emitters) | rw/m24-foreign-fn-component-backend.md §6 **[hist]**; rw/m26-celfnc-and-component-build.md **[plan, unstarted]**; user-guide/writing-component-functions.md **[deleted, m39]** |
