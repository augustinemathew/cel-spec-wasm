...
The overview of extending CEL with your own functions: the `.celfn`
IDL, the backend prefixes, and each backend's registration surface.
Deep dives with worked examples live on their own pages:
