...
[![Conformance](https://img.shields.io/badge/CEL%20conformance-2085%2F2085%20applicable%20·%200%20fail-success)](conformance/README.md)
...
| | |
| --- | --- |
| Passing | **2085 / 2085 of applicable rows (100%)** — the 481 inapplicable rows are mostly the `dyn` feature, outside the static subset by design |
| Failing | **0** |
