...
| | |
| --- | --- |
| **Passing** | **1973 / 2454** of the upstream CEL conformance corpus (80.4%) |
| Of expressions attempted | **1973 / 1973 = 100%** (excludes the by-design skips below) |
...
| Failing | **0** — every attempted conformance row passes, in both link modes |
