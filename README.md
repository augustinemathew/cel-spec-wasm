...
| | |
| --- | --- |
| **Passing** | **1966 / 2454** of the upstream CEL conformance corpus (80.1%) |
| Of expressions attempted | **1966 / 1973 = 99.6%** (excludes the by-design skips below) |
...
| Failing | 7 — a handful of multi-byte-UTF-8 `size()` / timestamp-stringification edges |
