...
absl::StatusOr<celwasm::Value> ValueFromProto(const ProtoValue& v) {
  switch (v.kind_case()) {
    case ProtoValue::kNullValue:
      return celwasm::Value::Null();
    case ProtoValue::kBoolValue:
      return celwasm::Value::Bool(v.bool_value());
    case ProtoValue::kInt64Value:
      return celwasm::Value::Int(v.int64_value());
    case ProtoValue::kUint64Value:
      return celwasm::Value::Uint(v.uint64_value());
    case ProtoValue::kDoubleValue:
      return celwasm::Value::Double(v.double_value());
    ...
    case ProtoValue::kEnumValue:
      ...
      return celwasm::Value::Int(v.enum_value().value());
    case ProtoValue::kObjectValue: {
      ...
      return celwasm::Value::OwnedMessage(*std::move(msg_or));
    }
    ...
    case ProtoValue::kTypeValue:
      ...
      return celwasm::Value::Type(v.type_value());
...
// Mirror of `PrimitiveSpec` but producing a `celwasm::CelType` directly,
...
absl::StatusOr<celwasm::CelType> CelTypeFromPrimitive(
    ProtoType::PrimitiveType p) {
  switch (p) {
    case ProtoType::BOOL:
      return celwasm::CelType::Bool();
    case ProtoType::INT64:
      return celwasm::CelType::Int();
    case ProtoType::UINT64:
      return celwasm::CelType::Uint();
    case ProtoType::DOUBLE:
      return celwasm::CelType::Double();
    case ProtoType::STRING:
      return celwasm::CelType::String();
    case ProtoType::BYTES:
      return celwasm::CelType::Bytes();
...
absl::StatusOr<celwasm::CelType> CelTypeFromProtoType(const ProtoType& t) {
  ...
  if (t.type_kind_case() == ProtoType::kMessageType) {
    ...
    return celwasm::CelType::Message(t.message_type());
  }
