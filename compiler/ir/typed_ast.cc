...
Repr ReprOf(const cel::Type& type) {
  switch (type.kind()) {
    case cel::TypeKind::kNull:      return Repr::kNull;
    case cel::TypeKind::kBool:      return Repr::kBool;
    case cel::TypeKind::kInt:       return Repr::kInt;
    case cel::TypeKind::kUint:      return Repr::kUint;
    case cel::TypeKind::kDouble:    return Repr::kDouble;
    case cel::TypeKind::kString:    return Repr::kString;
    case cel::TypeKind::kBytes:     return Repr::kBytes;
    case cel::TypeKind::kDuration:  return Repr::kDuration;
    case cel::TypeKind::kTimestamp: return Repr::kTimestamp;
    case cel::TypeKind::kList:      return Repr::kList;
    case cel::TypeKind::kMap:       return Repr::kMap;
    case cel::TypeKind::kStruct:    return Repr::kMessage;
    case cel::TypeKind::kEnum:      return Repr::kEnum;
    case cel::TypeKind::kType:      return Repr::kType;
    ...
    case cel::TypeKind::kAny:       return Repr::kMessage;
    case cel::TypeKind::kBoolWrapper:   return Repr::kBool;
    case cel::TypeKind::kIntWrapper:    return Repr::kInt;
    case cel::TypeKind::kUintWrapper:   return Repr::kUint;
    case cel::TypeKind::kDoubleWrapper: return Repr::kDouble;
    case cel::TypeKind::kStringWrapper: return Repr::kString;
    case cel::TypeKind::kBytesWrapper:  return Repr::kBytes;
    // Dyn / error / type-param / function / opaque / unknown: no scalar ABI.
    default: return Repr::kUnknown;
  }
}
