// Unit coverage for the Slice A code-point kernels in
// `cel_string_ext_codepoint.cc`: charAt, lowerAscii, upperAscii,
// trim, reverse.  Spec rows lifted from
// `tests/simple/testdata/string_ext.textproto` per-function
// sections (`char_at`, `ascii_casing`, `trim`, `reverse`).
...
// ===============================================================
// 3VL + kind-mismatch envelope for charAt.
// ===============================================================
